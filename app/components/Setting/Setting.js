...
export default class Setting extends Component {
  ...
  componentDidMount() {
    auth.profile()
    .then((response) => {
      this.setState({ namef: response.data.name_first, namel: response.data.name_last, nameslug: response.data.name_slug, email: response.data.email, birthday: response.data.date_birth }, () => {
