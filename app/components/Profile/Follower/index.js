    ...
    */
    if (typeof this.props.user_id === 'undefined') {
      AsyncStorage.getItem('userId')
        .then((myId) => {
          follows
            .searchFollower(this.state.name, myId)
            .then((res) => {
      ...
      follows
        .showFollower(this.props.user_id)
        .then((res) => {
          this.changeState(res);
        })
        .catch(err => this.showError(err));
          ...
          <Container>
            ...
            */}
                {this.state.someone !== '' && this.state.search === 1
                    ? <Text numberOfLines={2} style={styles.textWait}>
                      {strings.listfollow.nofollower} {this.state.someone}
                    </Text>
