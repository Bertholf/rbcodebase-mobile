...
export default {
  ...
  register: (name_first, name_last, name_slug, email, created_at, password, password_confirmation) => api.post('/api/users/register',
     { name_first, name_last, name_slug, email, created_at, password, password_confirmation, client_id: config.CLIENT_ID, client_secret: config.CLIENT_SECRET, grant_type: config.GRANT_TYPE }
  ),
