...
export default {
  ...
  updateProfile: (name_first, name_last) => api.put('/api/me',
    { name_first, name_last, client_id: config.CLIENT_ID, client_secret: config.CLIENT_SECRET, grant_type: config.GRANT_TYPE }
  ),
};
// app /services
